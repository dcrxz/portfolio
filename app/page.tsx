    ...
    <div className="min-h-screen bg-white text-slate-900 selection:bg-cyan-100 font-sans">
      ...
      <main className="content-container space-y-40 pb-40">
        ...
        <section id="case-studies">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="card-white h-full flex flex-col justify-center">
              ...
              <div className="flex gap-4 font-bold text-[10px] uppercase text-cyan-600 tracking-widest">
                <span>#Strategy</span> <span>#Governance</span>
              </div>
            </div>
            <div className="aspect-video bg-slate-50 rounded-3xl border border-slate-100 flex items-center justify-center font-bold text-slate-300 text-3xl uppercase tracking-tighter">
              Platform Migration
            </div>
          </div>
        </section>
        ...
        <section id="sample-projects">
          <h2 className="section-header">Sample Projects</h2>
          <div className="grid md:grid-cols-3 gap-8">
            <div className="card-white">
              <Workflow className="mb-8 text-cyan-600" size={40} />
              <h3 className="text-xl font-bold mb-4">Automation API Suite</h3>
            ...
            <div className="card-dark">
              ...
              <h3 className="text-xl font-bold mb-4">GenAI Simulation Hub</h3>
        ...
        <section id="expertise">
          <h2 className="section-header">Area of Expertise</h2>
        ...
        <section id="why-me">
          <h2 className="section-header">Why Me</h2>
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="space-y-12">
              <div className="flex gap-6 items-start">
                ...
                <div>
                  ...
                  <p className="text-slate-500 leading-relaxed text-sm">I translate mastery-aligned design principles into technical guidance, ensuring technology serves the science.</p>
                </div>
              </div>
              <div className="flex gap-6 items-start">
                ...
                <div>
                  ...
                  <p className="text-slate-500 leading-relaxed text-sm">Applying the logic of endurance optimization and metabolic efficiency to enterprise tech systems.</p>
                </div>
              </div>
            </div>
            <div className="card-flat p-12 italic text-lg text-slate-500 border-l-4 border-l-cyan-400">
              &ldquo;Strategy without execution is hallucination. I focus on measurable ROI and friction-less architecture.&rdquo;
            </div>
          </div>
        </section>
        ...
        <section id="work-with-me" className="py-32 bg-slate-900 rounded-[3rem] text-white text-center relative overflow-hidden shadow-2xl">
          <div className="relative z-10 max-w-4xl mx-auto px-8">
            ...
            <div className="flex flex-col md:flex-row gap-6 justify-center items-center">
              <a href="mailto:zurcdtsenre@gmail.com" className="btn-primary">
